...
func (m *MockUserService) AddJobDetails(ctx context.Context, jobRequest models.NewJobRequest, cid uint) (models.NewJobResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddJobDetails", ctx, jobRequest, cid)
...
func (mr *MockUserServiceMockRecorder) AddJobDetails(ctx, jobRequest, cid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddJobDetails", reflect.TypeOf((*MockUserService)(nil).AddJobDetails), ctx, jobRequest, cid)
}

// ApplyJobs mocks base method.
func (m *MockUserService) ApplyJobs(ctx context.Context, application []models.NewUserApplication) ([]models.NewUserApplication, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyJobs", ctx, application)
	ret0, _ := ret[0].([]models.NewUserApplication)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ApplyJobs indicates an expected call of ApplyJobs.
func (mr *MockUserServiceMockRecorder) ApplyJobs(ctx, application any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyJobs", reflect.TypeOf((*MockUserService)(nil).ApplyJobs), ctx, application)
}
