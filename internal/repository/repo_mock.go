...
func (m *MockUserRepo) CreateApplication(ctx context.Context, jid uint) (models.Jobs, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateApplication", ctx, jid)
...
func (mr *MockUserRepoMockRecorder) CreateApplication(ctx, jid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateApplication", reflect.TypeOf((*MockUserRepo)(nil).CreateApplication), ctx, jid)
}
...
func (m *MockUserRepo) CreateUserJob(ctx context.Context, jobData models.Jobs) (models.NewJobResponse, error) {
	m.ctrl.T.Helper()
